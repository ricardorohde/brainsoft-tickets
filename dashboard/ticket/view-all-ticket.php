            ...
            <div class="container-fluid">
                <header>
                    ...
                    <div id="status-sql" class="alert alert-success" style="display:block;">
                        <?php echo $_SESSION['ticketStatus'];
                    ...
                    <div id="status-sql" class="alert alert-danger" style="display:block;">
                        <?php echo $_SESSION['thereIsProblemInTicket'];
                        unset($_SESSION['thereIsProblemInTicket']); ?>
                    </div>
                    <?php endif ?>
                </header>
                <hr>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <button id="show-hide-filters" class="btn btn-info mb-3" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        ...
                        <div class="row">
                            <div class="col col-lg-3">
                                <select name="attendant" class="form-control" id="attendant" required>
                                    <?php if (!is_null($allTicketCtrl->getAttendants())) : ?>
                                    ...
                                    <?php endforeach ?>
                                    <?php else : ?>
                                    <option selected disabled>Nenhum atendente disponível</option>
                                    <?php endif ?>
                                </select>
                            </div>
                            <div class="col col-lg-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1" style="padding-left: 0px; text-align: left;">
                                <div class="btn-group dropleft" style="height: 83%;">
                                    <button type="button" class="btn btn-info dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="border-radius: 0px .25rem .25rem 0px;" title="Transferir">
