...
$(document).ready(function() {
  ...
  $('#side-admin-menu > li > a[href="' + href[2] + '"]')
    .parent()
    .addClass("active");
  ...
  $("#date_filter").change(function() {
    ...
    function setCookie(name, exdays) {
      ...
      document.cookie =
        name + "=" + date_required + "; expires=" + expires + "; path=/";
    ...
    $(this)
      ...
      .keypress(function(e) {
        if (e.which == 13) {
          ...
          $.post(
            "../../utils/controller/module/module-data.ctrl.php",
            { id: idModule, valor: novoConteudo },
            function(valor) {}
          );
        }
      });
  ...
  $("select[name=listUser]").change(function() {
    $.post(
      "../../utils/controller/ctrl-auth.php",
      { user: $(this).val() },
      function(auth) {
        $(".auth").empty();
        $(".auth").append(auth);
  ...
  $(".generate-report").click(function() {
    $.post(
      "../../utils/controller/ctrl-report.php",
      {
        makeReport: $(this).val(),
  ...
  $("input[name=category]").blur(function() {
    $.post(
      "../../../utils/controller/category/category-js.ctrl.php",
      { fromCategory: $(this).val() },
  ...
  $("input[name=registry]").blur(function() {
    $("select[name=client]").html(
      '<option value="">Selecione o cliente requerente</option>'
    );
    $.post(
      "../../../../utils/controller/client/client-js.ctrl.php",
      { registry: $(this).val() },
      function(client) {
  ...
  $("select[name=state]").change(function() {
    ...
    $("select[name=registry]").html(
      '<option value="">Selecione uma cidade</option>'
    );
    $.post(
      "../../../utils/controller/city/city-js.ctrl.php",
      { valor: $(this).val() },
      function(valor) {
  ...
  $("select[name=city]").change(function() {
    ...
    $.post(
      "../../../utils/controller/registry/registry-js.ctrl.php",
      { valor: $(this).val() },
      function(valor) {
  ...
  $("input[name=registryListToAdm]").blur(function() {
    $.post(
      "../../utils/controller/ctrl_registry.php",
      { fromFile: $(this).val() },
      function(fromFile) {
...
function ir_para_pagina(numero_da_pagina) {
  ...
  $("#conteudo")
    ...
    .slice(inicia, end_on)
    .css("display", "block");
  $(".page[longdesc=" + numero_da_pagina + "]")
    .addClass("active")
    .siblings(".active")
    .removeClass("active");
